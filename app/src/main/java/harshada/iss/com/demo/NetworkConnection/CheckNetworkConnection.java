package harshada.iss.com.demo.NetworkConnection;

import android.content.Context;
import android.os.AsyncTask;

import harshada.iss.com.demo.Utility.NetworkUtility;
...
public class CheckNetworkConnection extends AsyncTask<Void, Void, Boolean> {
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        boolean isConnected = new NetworkUtility().isNetWorkAvailableNow(context);
        return isConnected;
    }
